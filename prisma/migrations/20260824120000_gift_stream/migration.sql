...
CREATE TABLE "broadcaster_bili_sessions" (
    "id" SERIAL NOT NULL,
...
CREATE UNIQUE INDEX "broadcaster_bili_sessions_broadcaster_id_key" ON "broadcaster_bili_sessions"("broadcaster_id");
...
CREATE UNIQUE INDEX "received_gift_unique_key_key" ON "received_gift"("unique_key");
CREATE INDEX "received_gift_broadcaster_id_ts_idx" ON "received_gift"("broadcaster_id", "ts");
CREATE INDEX "received_gift_broadcaster_id_gift_id_idx" ON "received_gift"("broadcaster_id", "gift_id");
